                        ...
                        ...List.generate(options.length, (index) {
                          ...
                          return Padding(
                            ...
                            child: OptionCard(
                              ...
                              isEnabled:
                                  _isTimerActive && !_isAnswerSubmitted,
                              theme: theme,
            ...
            children: [
              ...
              if (widget.difficulty != null)
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: _getDifficultyColor(widget.difficulty!, isDark).withOpacity(0.1),
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
                      color: _getDifficultyColor(widget.difficulty!, isDark).withOpacity(0.3),
                    ),
                  ),
                  child: Text(
          ...
          Expanded(
            child: SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: (selectedOption != null && _isTimerActive && !_isAnswerSubmitted)
                    ? () => _handleNextQuestion()
                    : null,
                child: Text(
